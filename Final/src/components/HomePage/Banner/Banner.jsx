    ...
    return (
        ...
        py-8'>
            <div className='container'>
                ...
                items-center text-white rounded-3xl' style={{ backgroundColor: data.bgColor }}>
                    {/* first col */}
                    ...
                    <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                        ...
                        <div>
                            <button className='bg-white py-2 px-4 rounded-full' style={{ color: data.bgColor }} > Shop now</button>
                        </div>
                    </div>
                </div>
            </div>
