            ...
            <div className='container'>
                ...
                lg:grid-cols-4 gap-8">
                    ...
                    text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image1} alt="" className='absolute w-[320px] bottom-0' />
                    </div>
                    {/* second col */}
                    ...
                    text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image2} alt="" className='absolute w-[320px] -right-4 lg:top-[40px]' />
                    </div>
                    {/* third col */}
                    ...
                    text-white rounded-3xl relative h-[320px] flex items-end'>
                        ...
                        <img src={Image3} alt="" className='absolute w-[320px] top-1/2 -right-0 -translate-y-1/2' />
                    </div>
                </div>
